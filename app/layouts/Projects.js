    ...
    >
      <div className="title-wrapper container">
        ...
        <p className="section-text">
          As I am still learning, I have worked on a few projects and look
          forward to adding more examples as I complete them. I am always eager
          for new challenges and excited to collaborate on your next project.
          Let’s work together to take your business to the next level. Current
          Projects:
        </p>
      </div>
