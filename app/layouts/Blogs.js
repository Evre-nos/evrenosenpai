                ...
                <ul className="blog-list">
                    ...
                    <li>
                        <div className="blog-card">
                            ...
                            <figure className="card-banner img-holder" style={{ "--width": "700", "--height": "470" }}>
                                <Img src="blog-1.jpg" width="700" height="470" loading="lazy"
                                    alt="Did Apple need Steve?" className="img-cover" />
                            </figure>
                            ...
                            <div className="card-content">
                                ...
                                <div>
                                    ...
                                    <p className="card-text">
                                        Steve Jobs was a visionary, a genius, and a perfectionist. He was also a tyrant, a bully, and a control freak. But did Apple need him?
                                    </p>
                    ...
                    <li>
                        <div className="blog-card">
                            ...
                            <figure className="card-banner img-holder" style={{ "--width": "700", "--height": "470" }}>
                                <Img src="blog-2.jpg" width="700" height="470" loading="lazy"
                                    alt="Programming Guide 2024" className="img-cover" />
                            </figure>
                            ...
                            <div className="card-content">
                                ...
                                <div>
                                    ...
                                    <p className="card-text">
                                        The on face programming guide for 2024 and upcoming years. This guide will help you to understand the programming languages and their uses.
                                    </p>
